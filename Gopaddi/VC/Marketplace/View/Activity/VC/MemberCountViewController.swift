//
//  MemberCountViewController.swift
//  Gopaddi
//
...
class MemberCountViewController: UIViewController {
                ...
                func initSetUp(){
                    ...
                    self.scrollViewHeight.constant = 220
                ...
                @IBAction func didTapApplyBtn(_ sender: Any) {
                    ...
                    delegate?.peopleCount(adultC: finalAdultC, childC: finalChildC, childrenAgesList: ageListed)
