//
//  HotelConfirmPreviewHeadTableViewCell.swift
//  Gopaddi
//
...
class HotelConfirmPreviewHeadTableViewCell: UITableViewCell {
        static let identifier = "HotelConfirmPreviewHeadTableViewCell"
        ...
        let tickImageView1: UIImageView = {
        ...
        let tickImageView2: UIImageView = {
            let image = UIImageView()
            image.translatesAutoresizingMaskIntoConstraints = false
            image.clipsToBounds = true
            image.backgroundColor = .systemBlue
        ...
        let tickImageView3: UIImageView = {
            let image = UIImageView()
            image.translatesAutoresizingMaskIntoConstraints = false
            image.clipsToBounds = true
            image.backgroundColor = .systemBlue
        ...
        override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
            ...
            headerView.addSubview(no3View)
            headerView.addSubview(no4View)
            no2View.addSubview(tickImageView2)
            no3View.addSubview(tickImageView3)
            ...
            no1View.addSubview(tickImageView1)
        }
        ...
        override func layoutSubviews() {
            ...
            NSLayoutConstraint.activate([
                ...
                tickImageView1.centerYAnchor.constraint(equalTo: no1View.centerYAnchor),
                tickImageView1.centerXAnchor.constraint(equalTo: no1View.centerXAnchor),
                tickImageView1.heightAnchor.constraint(equalToConstant: 25),
                tickImageView1.widthAnchor.constraint(equalToConstant: 25),
                ...
                tickImageView2.centerYAnchor.constraint(equalTo: no2View.centerYAnchor),
                tickImageView2.centerXAnchor.constraint(equalTo: no2View.centerXAnchor),
                tickImageView2.heightAnchor.constraint(equalToConstant: 25),
                tickImageView2.widthAnchor.constraint(equalToConstant: 25),
                ...
                tickImageView3.centerYAnchor.constraint(equalTo: no3View.centerYAnchor),
                tickImageView3.centerXAnchor.constraint(equalTo: no3View.centerXAnchor),
                tickImageView3.heightAnchor.constraint(equalToConstant: 25),
                tickImageView3.widthAnchor.constraint(equalToConstant: 25),
